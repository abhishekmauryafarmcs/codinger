...
// Create array of selected problem IDs
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update selected problem IDs from form submission
    ...
    if (empty($selected_problem_ids)) $errors[] = "At least one problem is required";
